...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "The Artistry Hub" },
      { property: "og:title", content: "Atrium — Chat for communities" },
      { property: "og:description", content: "Spaces, channels, DMs, polls, events, and bots — brought to you by The Artistry Hub." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@TheArtistryHub" },
    ],
    links: [
      {
        rel: "stylesheet",
